...
.overlay {
	...
	background: linear-gradient(to right, #000000, #C07940);
...
<div class="container" id="container">
	<div class="form-container sign-up-container">
		<form action="RegistrationHandler.php" method="post">
            ...
            <a href="UniqueHomePage.html">Unique Homepage</a>
		</form>
	...
	<div class="form-container sign-in-container">
		<form action="loginHandler.php" method="post">
            ...
            <br>
            <a href="UniqueHomePage.html">Back to Home</a>
        </form>
	...
	<div class="overlay-container">
		<div class="overlay">
			...
			<div class="overlay-panel overlay-right">
				<h1>Hello!</h1>
				<p>Register with us to have an amazing experience !</p >
